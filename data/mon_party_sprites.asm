MonPartyData: ; 7190d (1c:590d)
	...
	dn SPRITE_MON, SPRITE_QUADRUPED			;Mew/Umbreon
	dn SPRITE_QUADRUPED, SPRITE_FAIRY       ;Baisen/Energuy
	dn SPRITE_MON, SPRITE_MON               ;Scizor/Dragor
	dn SPRITE_WATER, SPRITE_FAIRY           ;Oceaneel/Kruno
